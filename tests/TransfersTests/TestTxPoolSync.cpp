...
namespace {
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterANodeIsConnectedToAnotherIfTheirBlockchainsAreSynchronized) {
    ...
    std::unique_ptr<Dogero::INode> node0;
    std::unique_ptr<Dogero::INode> node1;
    std::unique_ptr<Dogero::INode> node2;
    std::unique_ptr<Dogero::INode> node3;
    ...
    std::vector<std::unique_ptr<Dogero::ITransactionReader>> poolTxs1;
    std::vector<std::unique_ptr<Dogero::ITransactionReader>> poolTxs2;
  ...
  TEST_F(NodeTxPoolSyncTest, TxPoolsAreRequestedRightAfterTimedBlockchainsSynchronization) {
    ...
    std::unique_ptr<Dogero::INode> node2;
    std::unique_ptr<Dogero::INode> node3;
    std::unique_ptr<Dogero::INode> node4;
    ...
    std::vector<std::unique_ptr<Dogero::ITransactionReader>> poolTxs2;
    std::vector<std::unique_ptr<Dogero::ITransactionReader>> poolTxs3;
    std::vector<std::unique_ptr<Dogero::ITransactionReader>> poolTxs4;
