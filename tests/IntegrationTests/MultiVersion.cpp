...
public:
  ...
  MultiVersionTest(const Dogero::Currency& currency, System::Dispatcher& d, const Tests::Common::BaseFunctionalTestsConfig& config, Logging::ILogger& log) :
  ...
  void run() {
    ...
    Dogero::AccountBase stashAddress;
