...
public:
  ...
  bool check_tx_verification_context(const Dogero::tx_verification_context& tvc, bool tx_added, size_t event_idx, const Dogero::Transaction& tx);
  bool check_block_verification_context(const Dogero::block_verification_context& bvc, size_t event_idx, const Dogero::Block& block);

  bool mark_last_valid_block(Dogero::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_tx(Dogero::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool mark_invalid_block(Dogero::core& c, size_t ev_index, const std::vector<test_event_entry>& events);
  bool check_double_spend(Dogero::core& c, size_t ev_index, const std::vector<test_event_entry>& events);

private:
  Dogero::Block m_last_valid_block;
