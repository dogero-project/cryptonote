...
struct WalletRecord {
  ...
  Dogero::ITransfersContainer* container = nullptr;
...
typedef boost::multi_index_container <
  ...
  boost::multi_index::indexed_by <
    ...
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransfersContainerIndex>,
      BOOST_MULTI_INDEX_MEMBER(WalletRecord, Dogero::ITransfersContainer*, container) >
  >
> WalletsContainer;

struct UnlockTransactionJob {
  uint32_t blockHeight;
  Dogero::ITransfersContainer* container;
...
typedef boost::multi_index_container <
  Dogero::WalletTransaction,
  boost::multi_index::indexed_by <
    boost::multi_index::random_access < boost::multi_index::tag <RandomAccessIndex> >,
    boost::multi_index::hashed_unique < boost::multi_index::tag <TransactionIndex>,
      boost::multi_index::member<Dogero::WalletTransaction, Crypto::Hash, &Dogero::WalletTransaction::hash >
    >,
    boost::multi_index::ordered_non_unique < boost::multi_index::tag <BlockHeightIndex>,
      boost::multi_index::member<Dogero::WalletTransaction, uint32_t, &Dogero::WalletTransaction::blockHeight >
    >
  >
> WalletTransactions;

typedef std::pair<size_t, Dogero::WalletTransfer> TransactionTransferPair;
typedef std::vector<TransactionTransferPair> WalletTransfers;
typedef std::map<size_t, Dogero::Transaction> UncommitedTransactions;
