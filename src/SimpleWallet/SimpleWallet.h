...
namespace Dogero
{
  ...
  /*                                                                      */
  /************************************************************************/
  class simple_wallet : public Dogero::INodeObserver, public Dogero::IWalletLegacyObserver, public Dogero::INodeRpcProxyObserver {
  public:
    simple_wallet(System::Dispatcher& dispatcher, const Dogero::Currency& currency, Logging::LoggerManager& log);
  ...
  private:
    ...
    {
    public:
      refresh_progress_reporter_t(Dogero::simple_wallet& simple_wallet)
    ...
    private:
      Dogero::simple_wallet& m_simple_wallet;
  ...
  private:
    ...
    std::unique_ptr<Dogero::NodeRpcProxy> m_node;
