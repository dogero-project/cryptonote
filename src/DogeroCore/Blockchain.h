...
#include "DogeroCore/BlockIndex.h"
#include "DogeroCore/Checkpoints.h"
#include "DogeroCore/Currency.h"
#include "DogeroCore/IBlockchainStorageObserver.h"
#include "DogeroCore/ITransactionValidator.h"
#include "DogeroCore/SwappedVector.h"
...
namespace Dogero {
  ...
  class Blockchain : public Dogero::ITransactionValidator {
  public:
    ...
    bool handleGetObjects(NOTIFY_REQUEST_GET_OBJECTS_request& arg, NOTIFY_RESPONSE_GET_OBJECTS_request& rsp); //Deprecated. Should be removed with DogeroProtocolHandler.
  ...
  private:
    ...
    Blocks m_blocks;
    Dogero::BlockIndex m_blockIndex;
