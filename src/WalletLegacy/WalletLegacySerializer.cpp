...
WalletLegacySerializer::WalletLegacySerializer(Dogero::AccountBase& account, WalletUserTransactionsCache& transactionsCache) :
  account(account),
...
void WalletLegacySerializer::serialize(std::ostream& stream, const std::string& password, bool saveDetailed, const std::string& cache) {
  ...
  Dogero::BinaryOutputStreamSerializer serializer(plainStream);
  saveKeys(serializer);
...
void WalletLegacySerializer::saveKeys(Dogero::ISerializer& serializer) {
  Dogero::KeysStorage keys;
  Dogero::AccountKeys acc = account.getAccountKeys();
...
void WalletLegacySerializer::deserialize(std::istream& stream, const std::string& password, std::string& cache) {
  ...
  Dogero::BinaryInputStreamSerializer serializerEncrypted(stdStream);
...
void WalletLegacySerializer::loadKeys(Dogero::ISerializer& serializer) {
  Dogero::KeysStorage keys;

  keys.serialize(serializer, "keys");

  Dogero::AccountKeys acc;
