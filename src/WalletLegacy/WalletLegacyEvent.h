...
public:
  ...
  virtual void notify(Tools::ObserverManager<Dogero::IWalletLegacyObserver>& observer) = 0;
};
...
public:
  ...
  virtual void notify(Tools::ObserverManager<Dogero::IWalletLegacyObserver>& observer) override
  {
