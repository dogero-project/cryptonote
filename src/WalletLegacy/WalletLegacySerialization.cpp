...
void serialize(UnconfirmedTransferDetails& utd, Dogero::ISerializer& serializer) {
...
void serialize(WalletLegacyTransaction& txi, Dogero::ISerializer& serializer) {
  ...
  Dogero::serializeBlockHeight(serializer, txi.blockHeight, "block_height");
...
void serialize(WalletLegacyTransfer& tr, Dogero::ISerializer& serializer) {
